...
export function bidMessageToFreelancer(data: bidMessageType) {
  return {
    ...
    message: [
      [
        `🎉 Congrats, on your bid on ${data.title}, we care about each proposals you send and we are ready to help you win the job, by always notifying you as at when due.`,
