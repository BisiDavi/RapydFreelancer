...
export default function Homebanner() {
  return (
    <section className="banner lg:mt-10 justify-between flex flex-col lg:flex-row items-center p-5  bg-gray-100 w-full">
      ...
      <div className="w-1/2 flex mx-auto justify-center hidden lg:flex">
        <div className="w-2/3">
          <Image
