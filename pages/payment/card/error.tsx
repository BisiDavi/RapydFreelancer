...
export default function CardActivationError() {
  return (
    <DefaultLayout title="Error Activating Your Card">
      <section className="container flex items-start mx-auto my-10">
        <div className="content w-full mx-auto flex flex-col justify-center p-6  ml-4 rounded  bg-gray-100">
          ...
          />
          <h4 className="font-bold text-xl text-center my-4">
            Error Activating your Card
          </h4>
